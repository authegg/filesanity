...
ROUTES = ['/', '/how-it-works', '/photos', '/documents', '/pdf', '/formats', '/pricing', '/batch', '/cli', '/api', '/extension', '/security', '/faq', '/about', '/contact', '/privacy', '/terms', '/changelog', '/blog', '/blog/what-a-jpeg-carries', '/404.html']
